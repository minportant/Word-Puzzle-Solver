	...
	for(int l = 3; l < 23; l++){
	  if(tbl.contains(getWordInGrid(i,j,k,l,rows,cols)) && strlen(getWordInGrid(i,j,k,l,rows,cols)) == l){
	    if(k==0){
	      ...
	      wordQueue.push(line);
	      //cout<<"N ("<< i <<", "<< j<<"):\t" << getWordInGrid(i,j,k,l,rows,cols) << endl;
	    }else
	    if(k==1){
	      stringstream ss;
	      stringstream ss2;
	    ...
	    if(k==2){
	      ...
	      wordQueue.push(line);
	      //cout<<"E ("<< i <<", "<< j<<"):\t" << getWordInGrid(i,j,k,l,rows,cols) << endl;
	    }else
	    if(k==3){
	      stringstream ss;
	      stringstream ss2;
	      ...
	      wordQueue.push(line);
	      //cout<<"SE("<< i <<", "<< j<<"):\t" << getWordInGrid(i,j,k,l,rows,cols) << endl;
	    }else
	    if(k==4){
	      stringstream ss;
	      stringstream ss2;
	      ...
	      wordQueue.push(line);
	      //cout<<"S ("<< i <<", "<< j<<"):\t" << getWordInGrid(i,j,k,l,rows,cols) << endl;
	    }else
	    if(k==5){
	      stringstream ss;
	      stringstream ss2;
	      ...
	      wordQueue.push(line);
	      //cout<<"SW("<< i <<", "<< j<<"):\t" << getWordInGrid(i,j,k,l,rows,cols) << endl;
	    }else
	    if(k==6){
	      stringstream ss;
	      stringstream ss2;
	      ...
	      wordQueue.push(line);
	      //cout<<"W ("<< i <<", "<< j<<"):\t" << getWordInGrid(i,j,k,l,rows,cols) << endl;
	    }else
	    if(k==7){
	      stringstream ss;
	      stringstream ss2;
	      ...
	      wordQueue.push(line);
	      //cout<<"NW("<< i <<", "<< j<<"):\t" << getWordInGrid(i,j,k,l,rows,cols) << endl;
	    }
	    count++;
	  }
	}
